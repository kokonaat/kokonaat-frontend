...
// export function UomMultiDeleteDialog<TData extends { id: string }>({
//     open,
//     onOpenChange,
//     table,
...
//             ),
//             {
//                 loading: 'Deleting Uoms...',
//                 success: () => {
//                     table.resetRowSelection()
//                     return `Deleted ${selectedRows.length} ${selectedRows.length > 1 ? 'Uoms' : 'Uom'
//                         }`
//                 },
...
//                     {selectedRows.length > 1 ? 'Uoms' : 'Uom'}
//                 </span>
//             }
//             desc={
//                 <div className='space-y-4'>
//                     <p className='mb-2'>
//                         Are you sure you want to delete the selected Uoms? <br />
