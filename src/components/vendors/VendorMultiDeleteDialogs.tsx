...
import { VendorMultiDeleteDialogProps } from '@/interface/vendorInterface'

const CONFIRM_WORD = 'DELETE'

export function VendorMultiDeleteDialog<TData extends { id: string }>({
  open,
  onOpenChange,
  table,
    ...
    toast.promise(
      ...
      ),
      {
        ...
        success: () => {
          ...
          return `Deleted ${selectedRows.length} ${selectedRows.length > 1 ? 'Vendors' : 'Vendor'
            }`
        },
    ...
    <ConfirmDialog
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            Are you sure you want to delete the selected Vendors? <br />
