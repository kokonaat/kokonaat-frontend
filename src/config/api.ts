...
export const apiEndpoints: ApiEndpoints = {
  ...
  user: {
    ...
    assignableRoles: '/user/role/assignable-roles',
    createUser: '/user/add-user-to-shop',
    updateEmployee: '/user/update-employee',
    resetEmployeePassword: '/user/reset-employee-password',
    employeePermissions: '/user/employee-permissions',
    modulePermissions: '/user/permissions/modules',
    changePassword: '/user/change-password',
  },
  subscriptionPlans: {
    subscriptionList: '/subscription/plans',
    myPlan: '/subscription/my-plan',
